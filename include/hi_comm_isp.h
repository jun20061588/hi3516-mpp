...
typedef struct hiISP_MOD_PARAM_S {
    ...
    HI_U32      u32QuickStart;  /*RW;Range:[0,1]; Format:32.0; Indicate ISP Quick StartNo distinction vipipe*/
} ISP_MOD_PARAM_S;
...
typedef union hiISP_MODULE_CTRL_U {
    ...
    struct {
        ...
        HI_U64  bitBypassRadialCrop    : 1 ;   /* RW;[15]; Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        ...
        HI_U64  bitBypassRadialShading : 1 ;   /* RW;[23]; Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        ...
        HI_U64  bitBypassAFStatFE      : 1 ;   /* RW;[28] ; Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        ...
        HI_U64  bitBypassHLC           : 1 ;   /* RW;[32] ; Not support for Hi3559V200/Hi3556V200 */
        HI_U64  bitBypassEdgeMark      : 1 ;   /* RW;[33] ; Not support for Hi3559V200/Hi3556V200 */
        HI_U64  bitBypassRGBIR         : 1 ;   /* RW;[34] ; Not support*/
        HI_U64  bitRsv29               : 29 ;  /* H  ; [33:63] */
    };
} ISP_MODULE_CTRL_U;
/*
...
typedef struct hiISP_WDR_FS_ATTR_S {
    ...
    ISP_WDR_BNR_ATTR_S stBnr;         /*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
...
typedef struct hiISP_DRC_MANUAL_ATTR_S {
    HI_U16  u16Strength;          /* RW;Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] | Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF]|
                                                                              Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF]; Strength of dynamic range compression.
...
typedef struct hiISP_DRC_AUTO_ATTR_S {
    HI_U16  u16Strength;          /* RW;Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] | Hi3516CV500 = [0x0, 0x3FF]| Hi3516DV300 = [0x0, 0x3FF] |
                                                                             Hi3559V200 = [0x0, 0x3FF]| Hi3556V200 = [0x0, 0x3FF];
    ...
    HI_U16 u16StrengthMax; /* RW; Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] | Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF] |
                                                                   Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF]; Maximum DRC strength in Auto mode */
    HI_U16 u16StrengthMin; /* RW; Range: Hi3559AV100 = [0x0, 0xFF] | Hi3519AV100 = [0x0, 0x3FF] | Hi3516CV500 = [0x0, 0x3FF] | Hi3516DV300 = [0x0, 0x3FF] |
                                                                   Hi3559V200 = [0x0, 0x3FF] | Hi3556V200 = [0x0, 0x3FF]; Minimum DRC strength in Auto mode */
...
typedef struct hiISP_DRC_ATTR_S {
    ...
    HI_U8  u8SpatialFltCoef; /* RW; Range: Hi3559AV100 = [0x0, 0xA] | Hi3519AV100 = [0x0, 0x5] | Hi3516CV500 = [0x0, 0x5] | Hi3516DV300 = [0x0, 0x5] |
                                                                      Hi3559V200 = [0x0, 0x5] | Hi3556V200 = [0x0, 0x5]; Spatial filter coefficients */
    ...
    HI_U8   u8DpDetectRangeRatio; /* RW; Range:[0x0, 0x1F]; Not support */
    HI_U8   u8DpDetectThrSlo;     /* RW; Range:[0x0, 0x1F]; Not support  */
    HI_U16  u16DpDetectThrMin;    /* RW; Range:[0x0, 0xFFFF]; Not support  */
...
typedef struct hiISP_LDCI_GAUSS_COEF_ATTR_S {
    HI_U8   u8Wgt;      /*RW;Range:Hi3559AV100 = [0x0, 0x80] | Hi3519AV100 = [0x0, 0x80]| Hi3516CV500 = [0x0, 0xFF] | Hi3516DV300 = [0x0, 0xFF]|
                                                           Hi3559V200 = [0x0, 0xFF] | Hi3556V200 = [0x0, 0xFF];Format:1.7;Weight of Gaussian distribution*/
...
typedef struct hiISP_CP_LUT_S {
    HI_U8   au8CPLutY[HI_ISP_CA_YRATIO_LUT_LENGTH];/*RW;Range:[0,255];Format:8.0;Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U8   au8CPLutU[HI_ISP_CA_YRATIO_LUT_LENGTH];/*RW;Range:[0,255];Format:8.0;Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U8   au8CPLutV[HI_ISP_CA_YRATIO_LUT_LENGTH];/*RW;Range:[0,255];Format:8.0;Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
} ISP_CP_LUT_S;
...
typedef struct hiISP_CA_ATTR_S {
    ...
    ISP_CA_TYPE_E eCaCpEn;      /*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    ISP_CA_LUT_S stCA;          /*Not support for Hi3559V200/Hi3556V200*/
    ISP_CP_LUT_S stCP;          /*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
} ISP_CA_ATTR_S;
...
typedef struct hiISP_SHADING_ATTR_S {
    ...
    HI_U16  u16MeshStr;         /*RW; Range:Hi3559AV100=[0, 65535]| Hi3519AV100=[0, 65535]|Hi3516CV500=[0, 65535]|Hi3516DV300=[0, 65535]|
                                                                         Hi3559V200=[0, 65535]|Hi3556V200=[0, 65535]; The strength of the mesh shading correction*/
...
typedef struct hiISP_SHADING_LUT_ATTR_S {
    ...
    HI_U16  au16XGridWidth[(HI_ISP_LSC_GRID_COL - 1) / 2]; /*RW; Range:Hi3559AV100=[4, 1988]| Hi3519AV100=[4, 1988]|Hi3516CV500=[4, 1092]|Hi3516DV300=[4, 1092]|
                                                                                                                      Hi3559V200=[4, 1092]|Hi3556V200=[4, 1092];limited Range:[4, u32Width/4 - 60],
    ...
    HI_U16  au16YGridWidth[(HI_ISP_LSC_GRID_ROW - 1) / 2]; /*RW; Range:Hi3559AV100=[4, 1988]| Hi3519AV100=[4, 1988]|Hi3516CV500=[4, 1092]|Hi3516DV300=[4, 1092]|
                                                                                                                      Hi3559V200=[4, 1092]|Hi3556V200=[4, 1092];limited Range:[4, u32Height/4 - 60],
...
typedef struct hiISP_RADIAL_SHADING_ATTR_S {
    HI_BOOL bEnable;          /*RW; Range:[0, 1];Format:1.0; HI_TRUE: enable rlsc; HI_FALSE: disable rlsc ,Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16RadialStr;     /*RW; Range:[0, 65535];Format:4.12; the strength of the mesh shading correction ,Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
} ISP_RADIAL_SHADING_ATTR_S;

/*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
typedef struct hiISP_RADIAL_SHADING_LUT_S {
    HI_U16  au16RGain[HI_ISP_RLSC_POINTS];  /*RW; Range:[0,65535];Member used to store the calibration data of the R channel required for RLSC.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  au16GrGain[HI_ISP_RLSC_POINTS]; /*RW; Range:[0,65535];Member used to store the calibration data of the Gr channel required for RLSC.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  au16GbGain[HI_ISP_RLSC_POINTS]; /*RW; Range:[0,65535];Member used to store the calibration data of the Gb channel required for RLSC.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  au16BGain[HI_ISP_RLSC_POINTS];  /*RW; Range:[0,65535];Member used to store the calibration data of the B channel required for RLSC.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
} ISP_RADIAL_SHADING_GAIN_LUT_S;

/*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
typedef struct hiISP_RADIAL_SHADING_LUT_ATTR_S {
    OPERATION_MODE_E enLightMode;   /*RW; Range:[0, 1];Format:1.0; HI_TRUE: manual mode; HI_FALSE: auto mode.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16BlendRatio;          /*RW; Range:[0, 256];Format:8.0; Used in manual mode only, indicates the light blending strength for the first light info.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U8   u8LightType1;           /*RW; Range:[0, 2];Format:2.0; Used in manual mode only, indicates the first light source selected.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U8   u8LightType2;           /*RW; Range:[0, 2];Format:2.0; Used in manual mode only, indicates the second light source selected.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U8   u8RadialScale;          /*RW; Range:[0, 13];Format:4.0;Four bit value that selects the scale and precision for the 10 bit gain coefficients.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterRX;     /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width], shows x value of the position of optical center of red channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterRY;     /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height], shows y value of the position of optical center of red channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterGrX;    /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width], shows x value of the position of optical center of gr channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterGrY;    /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height], shows y value of the position of optical center of gr channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterGbX;    /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width], shows x value of the position of optical center of gb channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterGbY;    /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height], shows y value of the position of optical center of gb channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterBX;     /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width], shows x value of the position of optical center of blue channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16CenterBY;     /*RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height], shows y value of the position of optical center of blue channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16OffCenterR;   /*RW; Range:[0, 65535];Format:16.0;related to the 1/R^2 value of red channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16OffCenterGr;  /*RW; Range:[0, 65535];Format:16.0;related to the 1/R^2 value of gr channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16OffCenterGb;  /*RW; Range:[0, 65535];Format:16.0;related to the 1/R^2 value of gb channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16  u16OffCenterB;   /*RW; Range:[0, 65535];Format:16.0;related to the 1/R^2 value of blue channel.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    ISP_RADIAL_SHADING_GAIN_LUT_S astRLscGainLut[3];/*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
...
typedef struct hiISP_NR_WDR_ATTR_S {
    ...
    HI_U8    au8FusionFrameStr[WDR_MAX_FRAME_NUM];    /*RW;Range:[0x0,0x50];Format:7.0; Strength of each frame in wdr mode. Only used for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
} ISP_NR_WDR_ATTR_S;

typedef struct hiISP_NR_ATTR_S {
    HI_BOOL  bEnable;                                     /*RW;Range:[0x0,0x1];Format:1.0; Nr Enable*/
    HI_BOOL  bLowPowerEnable;                             /*RW;Range:[0x0,0x1];Format:1.0; Nr Low Power Enable. Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    ...
    HI_U8    u8NrLscRatio;                                /*RW;Range:[0x0,0xff];Format:8.0; Ratio of referring to lens shading. Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U8    u8BnrLscMaxGain;                             /*RW;Range:[0x0,0xbf];Format:2.6; Max gain for referring to lens shading.Only used for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16   u16BnrLscCmpStrength;                        /*RW;Range:[0x0,0x100];Format:1.8; Compare strength for referring to lens shading.Only used for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
...
typedef struct hiISP_RGBIR_ATTR_S {
    HI_BOOL              bEnable    ;      /*RW;Range:[0x0,0x1];Format:1.0; Enable/Disable RGBIR module,Not support */
    ISP_IRBAYER_FORMAT_E enInPattern;      /*RW;Range:[0x0,0x7];Format:3.0; IR pattern of the output signal ,Not support*/
    ISP_BAYER_FORMAT_E   enOutPattern;     /*RW;Range:[0x0,0x3];Format:2.0; Bayer pattern of the output signal ,Not support*/

    HI_U16               au16ExpCtrl[ISP_EXP_CTRL_NUM];    /*RW;Range:[0, 2047];Format:11.0; Over expose control parameter ,Not support*/
    HI_U16               au16Gain[ISP_EXP_CTRL_NUM];       /*RW;Range:[0, 511];Format:9.0; Over expose control parameter ,Not support*/

    ISP_IR_CVTMAT_MODE_E enIRCvtMatMode;
    HI_S16               as16CvtMatrix[ISP_CVTMAT_NUM]; /*RW;Range:[-32768, 32767];Format:s15.0; RGBIR to Bayer image Convert matrix coefficients(need calibration) ,Not support*/
} ISP_RGBIR_ATTR_S;
...
typedef struct hiISP_SHARPEN_MANUAL_ATTR_S {
    HI_U8  au8LumaWgt[ISP_SHARPEN_LUMA_NUM];     /* RW; Range: Hi3559AV100 =[0,127]|Hi3519AV100=[0,127]|Hi3516CV500 = [0, 127]|Hi3516DV300 =[0, 127]|
                                                                                                        Hi3559V200 = [0, 127]|Hi3556V200 =[0, 127]|Hi3516EV200 = [0, 31]; Format:0.7;
    ...
    HI_U8  u8WeakDetailGain;       /* RW; Range: [0, 127];  Only support for Hi3516EV200; sharpen Gain for weakdetail*/
...
typedef struct hiISP_SHARPEN_AUTO_ATTR_S {
    HI_U8  au8LumaWgt[ISP_SHARPEN_LUMA_NUM][ISP_AUTO_ISO_STRENGTH_NUM];      /* RW; Range:Hi3559AV100 =[0,127]|Hi3519AV100=[0,127]|Hi3516CV500 = [0, 127]|
                                                                                                                                            Hi3516DV300 =[0, 127]| Hi3559V200 = [0, 127] |Hi3556V200 = [0, 127]|Hi3516EV200 = [0, 31]; Format:0.7;
                                                                                                                                            Adjust the sharpen strength according to luma. Sharpen strength will be weaker when it decrease. */
...
typedef struct hiISP_EDGEMARK_ATTR_S {
    HI_BOOL bEnable;              /* RW; Range:[0, 1]; Format:1.0;Enable/Disable Edge Mark. Not support for Hi3559V200/Hi3556V200*/
    HI_U8   u8Threshold;          /* RW; Range: [0, 255];  Format:8.0;Not support for Hi3559V200/Hi3556V200*/
    HI_U32  u32Color;             /* RW; Range: [0, 0xFFFFFF];  Format:32.0;Not support for Hi3559V200/Hi3556V200*/
} ISP_EDGEMARK_ATTR_S;
...
typedef struct hiISP_CR_ATTR_S {
    ...
    HI_U8    u8Slope;       /* RW; Range: Hi3559AV100 = [0, 14] | Hi3519AV100 = [0, 14]|Hi3516CV500 = [0, 14]|Hi3516DV300 =[0, 14];Crosstalk slope value.*/
    HI_U8    u8SensiSlope;  /* RW; Range: Hi3559AV100 = [0, 14] | Hi3519AV100 = [0, 14]|Hi3516CV500 = [0, 14]|Hi3516DV300 =[0, 14];Crosstalk sensitivity.*/
    HI_U16   u16SensiThr;   /* RW; Range: Hi3559AV100 = [0, 16383] | Hi3519AV100 = [0, 16383]|Hi3516CV500 = [0, 16383]|Hi3516DV300 =[0, 16383];Crosstalk sensitivity threshold.*/
...
typedef struct hiISP_DEMOSAIC_MANUAL_ATTR_S {
    ...
    HI_U8   u8NonDirMFDetailEhcStr; /*RW; Range:Hi3559AV100 = [0x0, 0x10] |Hi3519AV100 = [0x0, 0x7f] |Hi3516CV500= [0x0, 0x7f]|Hi3516DV300= [0x0, 0x7f]|
                                                                                Hi3559V200= [0x0, 0x7f]|Hi3556V200= [0x0, 0x7f]; Format:3.4; Non-direction medium frequent detail enhance  strength*/
    ...
    HI_U8   u8DetailSmoothRange;    /*RW; Range:Hi3559AV100 = [0x1, 0x8] |Hi3519AV100 = [0x1, 0x7] |Hi3516CV500 = [0x1, 0x7]|Hi3516DV300 = [0x1, 0x7]|
                                                                                Hi3559V200 = [0x1, 0x7]|Hi3556V200 = [0x1, 0x7]; Format:4.0; Detail smooth range*/
...
/*Defines the lateral chromatic aberration correction attribute, Not support for Hi3559V200/Hi3556V200*/
typedef struct hiISP_GLOBAL_CAC_ATTR_S {
    HI_BOOL bEnable;            /* RW; Range: [0, 1];Format: 1.0;  enable/disable global cac*/
    HI_U16  u16VerCoordinate;   /* RW; Range: [0, 8191];Format: 13.0; limited Range: [0, ImageHeight - 1],Vertical coordinate of the optical center.  Not support for Hi3559V200/Hi3556V200*/
    HI_U16  u16HorCoordinate;   /* RW; Range: [0, 8191];Format: 13.0; limited range : [0, ImageWidth - 1],Horizontal coordinate of the optical center. Not support for Hi3559V200/Hi3556V200*/
    HI_S16  s16ParamRedA;       /* RW; Range: [-256, 255];Format: 9.0; Coefficient a of the radius polynomial corresponding to channel R. Not support for Hi3559V200/Hi3556V200*/
    HI_S16  s16ParamRedB;       /* RW; Range: [-256, 255];Format: 9.0; Coefficient b of the radius polynomial corresponding to channel R. Not support for Hi3559V200/Hi3556V200*/
    HI_S16  s16ParamRedC;       /* RW; Range: [-256, 255];Format: 9.0; Coefficient c of the radius polynomial corresponding to channel R. Not support for Hi3559V200/Hi3556V200*/
    HI_S16  s16ParamBlueA;      /* RW; Range: [-256, 255];Format: 9.0; Coefficient a of the radius polynomial corresponding to channel B. Not support for Hi3559V200/Hi3556V200*/
    HI_S16  s16ParamBlueB;      /* RW; Range: [-256, 255];Format: 9.0; Coefficient b of the radius polynomial corresponding to channel B. Not support for Hi3559V200/Hi3556V200*/
    HI_S16  s16ParamBlueC;      /* RW; Range: [-256, 255];Format: 9.0; Coefficient c of the radius polynomial corresponding to channel B. Not support for Hi3559V200/Hi3556V200*/
    HI_U8   u8VerNormShift;     /* RW; Range: [0, 7];Format: 3.0; Normalized shift parameter in the vertical direction. Not support for Hi3559V200/Hi3556V200*/
    HI_U8   u8VerNormFactor;    /* RW; Range: [0, 31];Format: 5.0;Normalized coefficient in the vertical direction. Not support for Hi3559V200/Hi3556V200*/
    HI_U8   u8HorNormShift;     /* RW; Range: [0, 7];Format: 3.0; Normalized shift parameter in the horizontal direction. Not support for Hi3559V200/Hi3556V200*/
    HI_U8   u8HorNormFactor;    /* RW; Range: [0, 31];Format: 5.0;Normalized coefficient in the horizontal direction.Not support for Hi3559V200/Hi3556V200*/
    HI_U16  u16CorVarThr;       /* RW; Range: [0, 4095];Format: 12.0;Variance threshold of lateral chromatic aberration correction.Not support for Hi3559V200/Hi3556V200*/
...
typedef struct hiISP_AE_CROP_S {
    ...
    HI_U16  u16X;       /* RW; Range: Hi3559AV100 = [0, 8192 - 256]|Hi3519AV100 = [0, 8192 - 256]|Hi3516CV500 = [0, 4608 - 256]|Hi3516DV300 = [0, 4608 - 256]|
                                                              Hi3559V200   = [0, 4608 - 256]|Hi3556V200  = [0, 4608 - 256]; Format:13.0;AE image crop start x, limited range:[0, ImageWidth - 256] */
    HI_U16  u16Y;       /* RW; Range: Hi3559AV100 = [0, 8192 - 120]|Hi3519AV100 = [0, 8192 - 120]|Hi3516CV500 = [0, 4608 - 120]|Hi3516DV300 = [0, 4608 - 120]|
                                                              Hi3559V200   = [0, 4608 - 120]|Hi3556V200   = [0, 4608 - 120]; Format:13.0;AEimage crop start y, limited range:[0, ImageHeight - 120]  */
    HI_U16  u16W;       /* RW; Range: Hi3559AV100 = [256, 8192]|Hi3519AV100 = [256, 8192]|Hi3516CV500 = [256, 4608]|Hi3516DV300 = [256, 4608] |
                                                              Hi3559V200   = [256, 4608]| Hi3556V200  = [256, 4608]; Format:14.0;AE image crop width,  limited range:[256, ImageWidth] */
    HI_U16  u16H;       /* RW; Range: Hi3559AV100 = [120, 8192]|Hi3519AV100 = [120, 8192]|Hi3516CV500 = [120, 4608]|Hi3516DV300 = [120, 4608] |
                                                              Hi3559V200   = [120, 4608]| Hi3556V200  = [120, 4608]; Format:14.0;AE image crop height  limited range:[120, ImageHeight] */
} ISP_AE_CROP_S;
...
typedef struct hiISP_AF_H_PARAM_S {
    ...
    HI_U8           u8IIRShift;                 /* RW; Range: [0, 63]; IIR Shift. Not support for Hi3516CV500/Hi3516DV300*/
...
typedef union hiISP_STATISTICS_CTRL_U {
    ...
    struct {
        ...
        HI_U64  bit1FEAeStiGloStat  : 1 ;   /* [2] .Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        HI_U64  bit1FEAeStiLocStat  : 1 ;   /* [3] .Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        HI_U64  bit1BEAeGloStat     : 1 ;   /* [4] */
        HI_U64  bit1BEAeLocStat     : 1 ;   /* [5] */
        HI_U64  bit1BEAeStiGloStat  : 1 ;   /* [6] .Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        HI_U64  bit1BEAeStiLocStat  : 1 ;   /* [7] .Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
        HI_U64  bit1AwbStat1        : 1 ;   /* [8] */
        HI_U64  bit1AwbStat2        : 1 ;   /* [9] */
        HI_U64  bit2Rsv0            : 2 ;   /* [10:11] */
        HI_U64  bit1FEAfStat        : 1 ;   /* [12] .Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
...
typedef struct hiISP_AE_STATISTICS_S {
    ...
    HI_U16 au16FEZoneAvg[ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /*R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of FE.
                                                                                                                                                           Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200's Fe1 and Fe3*/
...
typedef struct hiISP_AE_STITCH_STATISTICS_S {
    HI_U32 au32FEHist1024Value[ISP_CHN_MAX_NUM][HIST_NUM];                                                  /*R; Range: [0x0, 0xFFFFFFFF]; Format:32.0; Global 1024 bins histogram of FE.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16 au16FEGlobalAvg[ISP_CHN_MAX_NUM][BAYER_PATTERN_NUM];                                             /*R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of FE.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16 au16FEZoneAvg[VI_MAX_PIPE_NUM][ISP_CHN_MAX_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM]; /*R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of FE.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U32 au32BEHist1024Value[HIST_NUM];                                                                   /*R; Range: [0x0, 0xFFFFFFFF]; Format:32.0; Global 1024 bins histogram of BE.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16 au16BEGlobalAvg[BAYER_PATTERN_NUM];                                                              /*R; Range: [0x0, 0xFFFF]; Format:16.0; Global average value of BE.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
    HI_U16 au16BEZoneAvg[VI_MAX_PIPE_NUM][AE_ZONE_ROW][AE_ZONE_COLUMN][BAYER_PATTERN_NUM];                  /*R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of BE.Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200*/
...
typedef struct hiISP_AWB_CROP_S {
    ...
    HI_U16  u16X;     /* RW; Range: Hi3559AV100 = [0, 8192 - 60]|Hi3519AV100 = [0, 8192 - 60]|Hi3516CV500 = [0, 4608 - 60]|Hi3516DV300 = [0, 4608 - 60]|
                                                          Hi3559V200   = [0, 4608 - 60]|Hi3556V200   = [0, 4608 - 60]; Format:13.0;AWB image crop start x, limited range:[0, ImageWidth - u16ZoneCol * 60]*/
    HI_U16  u16Y;     /* RW; Range: Hi3559AV100 = [0, 8192 - 14]|Hi3519AV100 = [0, 8192 - 14]|Hi3516CV500 = [0, 4608 - 14]|Hi3516DV300 = [0, 4608 - 14]|
                                                          Hi3559V200   = [0, 4608 - 14]|Hi3556V200   = [0, 4608 - 14]; Format:13.0;AWB image crop start y,limited range:[0, ImageHeight - u16ZoneRow * 14] */
    HI_U16  u16W;     /* RW; Range: Hi3559AV100 = [60, 8192]|Hi3519AV100 = [60, 8192]|Hi3516CV500 = [60, 4608]|Hi3516DV300 = [60, 4608] |
                                                          Hi3559V200   = [60, 4608]| Hi3556V200  = [60, 4608]; Format:14.0;AWB image crop width, limited range:[u16ZoneCol * 60, ImageWidth]*/
    HI_U16  u16H;     /* RW; Range: Hi3559AV100 = [14, 8192]|Hi3519AV100 = [14, 8192]|Hi3516CV500 = [14, 4608]|Hi3516DV300 = [14, 4608] |
                                                          Hi3559V200   = [14, 4608]| Hi3556V200  = [14, 4608]; Format:14.0;AWB image crop height, limited range:[u16ZoneRow * 14, ImageHeight]*/
} ISP_AWB_CROP_S;
...
typedef struct hiISP_WB_STATISTICS_CFG_S {
    ...
    HI_U16 u16ZoneBin;                    /*RW; Range:Hi3559AV100 = [1, 4] | Hi3519AV100 = [1, 4] | Hi3516CV500 = [1, 1]|Hi3516DV300 = [1, 1]|
                                                                                          Hi3559V200 = [1, 1]|Hi3556V200 = [1, 1]; Brightness Bins*/
...
typedef struct hiISP_AF_STATISTICS_S {
    ISP_FE_FOCUS_STATISTICS_S      stFEAFStat;/*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200 */
    ISP_BE_FOCUS_STATISTICS_S      stBEAFStat;/*Not support for Hi3559V200/Hi3556V200 */
    ISP_FOCUS_GRID_INFO_S          stFEAFGridInfo;/*Not support for Hi3516CV500/Hi3516DV300/Hi3559V200/Hi3556V200 */
