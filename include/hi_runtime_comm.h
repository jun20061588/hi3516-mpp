...
//errno message
#define HI_ERR_SVP_RUNTIME_BASE                        (HI_S32)(0xFF000F00)
#define HI_ERR_SVP_RUNTIME_UNINIT                      (HI_S32)(HI_ERR_SVP_RUNTIME_BASE + 1)
#define HI_ERR_SVP_RUNTIME_MODEL_NOLOAD                (HI_S32)(HI_ERR_SVP_RUNTIME_BASE + 2)
#define HI_ERR_SVP_RUNTIME_NULL_PTR                    (HI_S32)(HI_ERR_SVP_RUNTIME_BASE + 3)
#define HI_ERR_SVP_RUNTIME_INVALID_PARAM               (HI_S32)(HI_ERR_SVP_RUNTIME_BASE + 4)
#define HI_ERR_SVP_RUNTIME_SDK_ERROR                   (HI_S32)(HI_ERR_SVP_RUNTIME_BASE + 5)
#define HI_ERR_SVP_RUNTIME_SDK_NOMEM                   (HI_S32)(HI_ERR_SVP_RUNTIME_BASE + 6)
