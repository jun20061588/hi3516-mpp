...
/*Only used for Hi3516EV200*/
typedef struct {
    HI_U8  SPN6 : 3, SFR  : 5;                                      /*SPN6,SBN6:  [0,6];*/
    ...
    HI_U16  STH1 : 9,  SFN1 : 3, SFN0  : 3, NRyEn   : 1; /* STH1, STH2; Range: [0, 511]; The thresholds for protection of edges from blurring */
    /* NRyEn;      Range: [0,   1]; The NR switches */
    HI_U16  STH2 : 9,  SFN2 : 3, kMode : 3, _rb_;         /* SFN0~2;     Range: [0,   6]; Filter selection for different image areas based on STH1~3.*/
...
typedef struct {
    ...
    /* TSI0,TSI1;          Range: [0,   1]; The selection of blending filter for TSS. */
    HI_U8  TFRS : 4,   TED  : 2,   bRef    : 1,  _rb_ : 1; /* tEdge;  Range: [0,   3]; NR strength control mode for the updating background. */
    /* bRef;   Range: [0,   1]; The Switch for temproal filtering.  */
} tV200_VPSS_TFy;
...
typedef struct {
    ...
    HI_U16  MATH0   : 10,  MATE0 : 4,  MATW   : 2;                                 /* MATH0,MATH1;   Range: [0, 999]; The theshold for motion detection. */
    HI_U16  MATH1   : 10,  _rb2_ : 6;                                                      /* MATE0,MATE1;   Range: [0,   8]; The motion index for smooth image area.*/
    ...
    HI_U16  AdvMATH : 1,   AdvTH : 12, _rb3_  : 3;
} tV200_VPSS_MDy;
...
typedef struct hiVPSS_CHN_BUF_WRAP_S {
    ...
    HI_BOOL bBufCmp;              /* RW; Whether to allocate buffer according to compression. */
} VPSS_CHN_BUF_WRAP_S;
